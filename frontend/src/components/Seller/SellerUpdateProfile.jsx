  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${API_BASE_URL}/api/user/seller/update`, // Use the correct endpoint
        { ...formData },
        {
          headers: {
      ...
      navigate("/seller/dashboard/updateprofile");
    } catch (error) {
      console.error(
  ...
  return (
    <Container maxWidth="md" sx={{ mt: 4, p: 2 }}>
      <Typography variant="h4" align="center" gutterBottom>
        <AccountBoxIcon style={{ fontSize: 50 }} className="text-blue-300 px-2" />
        Update Profile
      </Typography>
